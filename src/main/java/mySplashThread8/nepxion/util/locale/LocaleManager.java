package mySplashThread8.nepxion.util.locale;
...
//nepxion-utility/src/com/nepxion/util/locale/UtilityLocale.java
	...
	implements LocaleConstants
{
	...
	{
		//labels = ResourceBundle.getBundle("manager", currentLocale);
